...
.tl-quarter-details > summary::-webkit-details-marker { display: none; }
.tl-quarter-details > summary:hover { background: #efefef; }
.tl-quarter-details[open] > summary { background: #f0f0f0; border-bottom: 1px solid #e0e0e0; }

.tl-q-left { display:flex; flex-direction:column; gap:5px; flex:1; }
.tl-q-label {
  font-size: 0.72rem;
  font-weight: 700;
  color: #fff;
...
.tl-q-bullets { display:flex; flex-wrap:wrap; gap:6px; margin-top:2px; }
.tl-q-bullet {
  font-size: 0.73rem;
  color: #555;
  background: #fff;
...
.tl-quarter-details[open] .tl-q-arrow { transform: rotate(90deg); }
...
.tl-card { border:1px solid #e8e8e8; border-radius:8px; padding:13px 15px; background:#fff; }
.tl-card:hover { border-color:#aaa; }
.tl-date { font-size:0.72rem; font-weight:600; color:#888; letter-spacing:.04em; margin-bottom:3px; }
.tl-title { font-size:0.92rem; font-weight:700; margin-bottom:6px; color:#222; }
...
/* 개별 항목 details */
.tl-item details summary { cursor:pointer; font-size:0.78rem; color:#888; margin-top:6px; }
.tl-item details summary:hover { color:#333; }
.tl-item details[open] summary { color:#333; }

/* 기업과제 섹션 */
.corp-section { margin-top: 2.5rem; border-top: 2px solid #e0e0e0; padding-top: 1.5rem; }
.corp-section-title {
...
.corp-card {
  border: 1px solid #e4d4ff; border-radius: 8px;
  padding: 14px 16px; background: #faf7ff; margin-bottom: 1rem;
}
...
<details class="tl-quarter-details">
  <summary>
    <div class="tl-q-left">
      <span class="tl-q-label">2025 Q3 · 7월 – 9월</span>
      <div class="tl-q-bullets">
        <span class="tl-q-bullet">RoboPoint 리뷰 & 구현</span>
        <span class="tl-q-bullet">ROS2 환경 구축</span>
        <span class="tl-q-bullet">Agentic AI 탐색</span>
        <span class="tl-q-bullet">Mobile Agent V2 / E</span>
        <span class="tl-q-bullet">AI Agent 파이프라인 설계</span>
      </div>
    </div>
...
<details class="tl-quarter-details">
  <summary>
    <div class="tl-q-left">
      <span class="tl-q-label">2025 Q4 · 10월 – 12월</span>
      <div class="tl-q-bullets">
        <span class="tl-q-bullet">Go2 하드웨어 세팅</span>
        <span class="tl-q-bullet">ConceptGraph 구현</span>
        <span class="tl-q-bullet">씬그래프 – Planner 연동</span>
        <span class="tl-q-bullet">B-1 로봇 세팅</span>
      </div>
    </div>
    <span class="tl-q-arrow">▶</span>
  </summary>
...
<details class="tl-quarter-details">
  <summary>
    <div class="tl-q-left">
      <span class="tl-q-label">2026 Q1 · 1월 – 3월</span>
      <div class="tl-q-bullets">
        <span class="tl-q-bullet">RoboPoint B-1 구현</span>
        <span class="tl-q-bullet">LLM + 씬그래프 end-to-end</span>
        <span class="tl-q-bullet">SayPlan 한계 분석</span>
        <span class="tl-q-bullet">REACT 씬그래프 업데이터</span>
        <span class="tl-q-bullet">Freespace 구현</span>
      </div>
    </div>
    <span class="tl-q-arrow">▶</span>
  </summary>
